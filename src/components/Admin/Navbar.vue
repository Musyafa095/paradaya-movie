<template>
  <div
  class="navbar bg-base-100 flex justify-end ">
      <!-- Theme Switcher -->
    ...
    <path
      ...
      <div class="dropdown dropdown-end"
        ...
        <ul
          ...
          tabindex="0"
          class="menu menu-sm dropdown-content bg-base-100 rounded-box z-[1] mt-3 w-52 p-2 shadow font-bold"
        >
          <li v-if="user">
          ...
          <li v-if="user && user.role.name === 'admin'">
